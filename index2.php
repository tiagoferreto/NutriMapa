...
document.onkeydown=enter; //Para o navegador reconhecer o comando da tecla 'enter'
	function Login(){ // Função que efetua o login
		...
		if (username=="anelisebor" && password=="nutrimapa") { window.location="loginCookie.php?username="+username+"&senha="+password; concluido=true; }
		...
		if (username=="renatazan" && password=="nutrimapa") { window.location="loginCookie.php?username="+username+"&senha="+password; concluido=true; }
